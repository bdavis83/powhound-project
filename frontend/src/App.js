...
import DisplaySearchConditionsPage from "./pages/DisplaySearchConditionsPage/DisplaySearchConditionsPage";
// Component Imports
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/historicalWeather/:id"
          element={<HistoricalWeatherPage />}
        />
        ...
        <Route
          path="/displaysearchconditions/"
          element={<DisplaySearchConditionsPage />}
        />
      </Routes>
      <Footer />
    </div>
